...
(function ($)
{
    ...
    $.ligerDefaults.Form.editorBulider = function (jinput)
    {
        ...
        //add by zhangzixiao 20160321 start
        var jinputOptions = jinput.attr("options");
        if(jinputOptions) {
            var jinputOpts = eval("("+jinputOptions+")");
            if(jinputOpts) {
                options = $.extend({},jinputOpts, options);
            }
        }
        //add by zhangzixiao 20160321 end
