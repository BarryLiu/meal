...
public class TableToJavaBean {
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        String jdbcString = "jdbc:sqlserver://localhost:1433; DatabaseName=meal_supplement_test";
        Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
        //Connection con = DriverManager.getConnection(jdbcString, "sa", "wheatek!1");  // LiKui123!@#
        Connection con = DriverManager.getConnection(jdbcString, "sa", "liuyingjing_123");
